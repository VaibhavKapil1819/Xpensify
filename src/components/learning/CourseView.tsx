                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-2 max-h-[200px] overflow-y-auto">
                    {Array.from(savedNotes.entries()).map(([key, note]) => (
                      <div
                        key={key}
                        className={`p-2 rounded-lg text-xs bg-gray-50 dark:bg-white/5 border ${key === currentNoteKey
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    className={`w-full justify-start text-xs font-bold h-12 rounded-lg border-2 transition-all ${showHint
                  ...
                  <Button
                    ...
                    className={`w-full justify-start text-xs font-bold h-12 rounded-lg border-2 transition-all ${showExplanation === 0
...
const InteractiveQuizView: React.FC<{
  ...
  onBack: () => void;
}> = ({ quiz, onComplete, onBack: _onBack }) => {

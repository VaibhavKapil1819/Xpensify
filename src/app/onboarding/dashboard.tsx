      ...
      <Card className="w-full max-w-2xl p-8 glass-card animate-fade-in">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-3xl font-bold gradient-text">Let's Get Started</h2>
        ...
        {step === 1 && (
          <div className="space-y-6 animate-fade-in">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-semibold">What's your primary financial goal?</h3>
            </div>
            <div className="space-y-2">
              <Label htmlFor="goal">Tell us what you want to achieve</Label>
              <Input
                id="goal"
                type="text"
                ...
                className="glass-input text-lg p-6"
              />
        ...
        {step === 2 && (
          <div className="space-y-6 animate-fade-in">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-semibold">What's your risk tolerance?</h3>
            </div>
            <RadioGroup value={riskLevel} onValueChange={(value: any) => setRiskLevel(value)}>
              <div className="space-y-3">
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    <RadioGroupItem value="conservative" id="conservative" />
                    <Label htmlFor="conservative" className="flex-1 cursor-pointer">
                      <div className="font-semibold">Conservative</div>
                      <p className="text-sm text-muted-foreground">I prefer safety over higher returns</p>
                    </Label>
                  </div>
                </Card>
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    ...
                    <Label htmlFor="moderate" className="flex-1 cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">I want balanced growth with some risk</p>
                    </Label>
                  </div>
                </Card>
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    ...
                    <Label htmlFor="aggressive" className="flex-1 cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">I'm comfortable with high risk for potential high returns</p>
                    </Label>
                  </div>
                </Card>
              </div>
                ...
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    ...
                    <Label htmlFor="visual" className="flex-1 cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">Charts, graphs, and infographics</p>
                    </Label>
                  </div>
                </Card>
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    ...
                    <Label htmlFor="text" className="flex-1 cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">Articles and written explanations</p>
                    </Label>
                  </div>
                </Card>
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    ...
                    <Label htmlFor="interactive" className="flex-1 cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">Quizzes and hands-on exercises</p>
                    </Label>
                  </div>
                </Card>
                <Card className="p-4 glass-card cursor-pointer hover:border-accent/50 transition-all">
                  <div className="flex items-center space-x-3">
                    ...
                    <Label htmlFor="mixed" className="flex-1 cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">A combination of everything</p>
                    </Label>
                  </div>
                </Card>
              </div>
